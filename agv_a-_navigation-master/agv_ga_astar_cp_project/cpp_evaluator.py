...
class CPPEvaluator:
    ...
    def _plan_one_task(self, res, agv_state, task):
        agv_id = agv_state["id"]
        ...
        # 5. Return to shared home, preserving the old project behavior.
        ...
        tardiness = max(0, delivery_time - task["window_end"])
    ...
    def evaluate(self, chrom: Chromosome, detailed: bool = False) -> EvaluationResult:
        ...
        while remaining > 0:
            ...
            plan = self._plan_one_task(res, agv_states[agv_id], task)
            if plan is None:
                infeasible_count += 1
            ...
            task_results.append({
                ...
                # delay now means time-window violation, not merely after window_start.
